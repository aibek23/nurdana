...
const Lecktion4 = () => {
  ...
  const [answer, setAnswer] = useState({
    span1: "___",color1: "",trueAnswer1:"komme",
    span2: "___",color2: "",trueAnswer2:"dir",
    span3: "___",color3: "",trueAnswer3:"Der Freund",
    span4: "___",color4: "",trueAnswer4:"Cool",
    span5: "___",color5: "",trueAnswer5:"Tee trinken",
  });
      ...
      <div className="container d-flex justify-content-center">
        ...
        <div>
          <form onSubmit={handleFormSubmit} className="mt-5">
           <h2 className="m-5">
              1. Ich {!answer.color1?<span style={{backgroundColor:answer.color1}}>{answer.span1}</span>:""} {answer.color1==="red"?<span style={{"position":"relative"}}>
           ...
           <h2 className="m-5">2.	Wie geht es{!answer.color2?<span style={{backgroundColor:answer.color2}}>{answer.span2}</span>:""} {answer.color2==="red"?<span style={{"position":"relative"}}>
           ...
           <h2 className="m-5">3.  друг - {!answer.color3?<span style={{backgroundColor:answer.color3}}>{answer.span3}</span>:""} {answer.color3==="red"?<span style={{"position":"relative"}}>
           ...
           <h2 className="m-5">4.Клёво  - {!answer.color4?<span style={{backgroundColor:answer.color4}}>{answer.span3}</span>:""} {answer.color4==="red"?<span style={{"position":"relative"}}>
           ...
           <h2 className="m-5">5. 	Ich möchte {!answer.color5?<span style={{backgroundColor:answer.color5}}>{answer.span5}</span>:""} {answer.color5==="red"?<span style={{"position":"relative"}}>
