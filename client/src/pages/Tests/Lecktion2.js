...
const Lecktion2 = () => {
  ...
  const [answer, setAnswer] = useState({
    span1: "___",color1: "",trueAnswer1:"Die",
    span2: "___",color2: "",trueAnswer2:"Aus Kirgisistan",
    span3: "___",color3: "",trueAnswer3:"In Bischkek",
    span4: "___",color4: "",trueAnswer4:"22",
    span5: "___",color5: "",trueAnswer5:"Heiße ",
  });
      ...
      <div className="container d-flex justify-content-center">
        ...
        <div>
          <form onSubmit={handleFormSubmit} className="mt-5">
           <h2 className="m-5">
              1. {!answer.color1?<span style={{backgroundColor:answer.color1}}>{answer.span1}</span>:""} {answer.color1==="red"?<span style={{"position":"relative"}}>
              ...
              </span>:answer.color1==="#75AD73FF"?<span style={{backgroundColor:answer.color1,padding:"3px"}}> {answers.question1} </span>:""} Lehrerin
           ...
           <h2 className="m-5">2. Ich komme {!answer.color2?<span style={{backgroundColor:answer.color2}}>{answer.span2}</span>:""} {answer.color2==="red"?<span style={{"position":"relative"}}>
           ...
           <h2 className="m-5">3. Ich wohne {!answer.color3?<span style={{backgroundColor:answer.color3}}>{answer.span3}</span>:""} {answer.color3==="red"?<span style={{"position":"relative"}}>
              ...
              </span>:answer.color3==="#75AD73FF"?<span style={{backgroundColor:answer.color3,padding:"3px"}}> {answers.question3} </span>:""} </h2>
              <ul>
                <li>Aus Bischkek</li>
                <li>Komme aus  Bischkek</li>
                <li>In Bischkek</li>
              </ul>
           ...
           <h2 className="m-5">4. dreiundreizig {!answer.color4?<span style={{backgroundColor:answer.color4}}>{answer.span3}</span>:""} {answer.color4==="red"?<span style={{"position":"relative"}}>
              ...
              </span>:answer.color4==="#75AD73FF"?<span style={{backgroundColor:answer.color4,padding:"3px"}}> {answers.question4} </span>:""} </h2>
                <ul>
                    <li>22</li>
                    <li>34</li>
                    <li>13</li>
           ...
           <h2 className="m-5">5. Ich  {!answer.color5?<span style={{backgroundColor:answer.color5}}>{answer.span5}</span>:""} {answer.color5==="red"?<span style={{"position":"relative"}}>
              ...
              </span>:answer.color5==="#75AD73FF"?<span style={{backgroundColor:answer.color5,padding:"3px"}}> {answers.question5} </span>:""} Peter.</h2>
              <ul>
                    <li>Komme</li>
                    <li>Lebe</li>
                    <li>Wohne</li>
