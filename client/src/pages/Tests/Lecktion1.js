...
const Lecktion1 = () => {
  ...
  const [answer, setAnswer] = useState({
    span1: "___",color1: "",trueAnswer1:"ist",
    span2: "___",color2: "",trueAnswer2:"Gut, und dir?",
    span3: "___",color3: "",trueAnswer3:"sprichst",
    span4: "___",color4: "",trueAnswer4:"ist",
    span5: "___",color5: "",trueAnswer5:"Deutsch",
  });
      ...
      <div className="container d-flex justify-content-center">
        ...
        <div>
          <form onSubmit={handleFormSubmit} className="mt-5">
           <h2 className="m-5">
              1. Guten Tag, mein Name {!answer.color1?<span style={{backgroundColor:answer.color1}}>{answer.span1}</span>:""} {answer.color1==="red"?<span style={{"position":"relative"}}>
           ...
           <h2 className="m-5">2. Wie geht es Ihnen? {!answer.color2?<span style={{backgroundColor:answer.color2}}>{answer.span2}</span>:""} {answer.color2==="red"?<span style={{"position":"relative"}}>
           ...
           <h2 className="m-5">3. Welche Sprachen {!answer.color3?<span style={{backgroundColor:answer.color3}}>{answer.span3}</span>:""} {answer.color3==="red"?<span style={{"position":"relative"}}>
              ...
              </span>:answer.color3==="#75AD73FF"?<span style={{backgroundColor:answer.color3,padding:"3px"}}> {answers.question3} </span>:""} du?</h2>
           ...
           <h2 className="m-5">4. Peter {!answer.color4?<span style={{backgroundColor:answer.color4}}>{answer.span3}</span>:""} {answer.color4==="red"?<span style={{"position":"relative"}}>
              ...
              </span>:answer.color4==="#75AD73FF"?<span style={{backgroundColor:answer.color4,padding:"3px"}}> {answers.question4} </span>:""} drei Jahre alt.</h2>
           ...
           <h2 className="m-5">5. Ich spreche {!answer.color5?<span style={{backgroundColor:answer.color5}}>{answer.span5}</span>:""} {answer.color5==="red"?<span style={{"position":"relative"}}>
              ...
              </span>:answer.color5==="#75AD73FF"?<span style={{backgroundColor:answer.color5,padding:"3px"}}> {answers.question5} </span>:""}.</h2>
