...
const Teil1 = () => {
  return (
    <div className="container text-center ">
      <div
        className="d-flex flex-column align-itmes-center justify-content-center"
      ...
      >
        ...
        <Player props={9} />
        <div
          className="container d-flex flex-wrap mt-3"
      ...
      <table className="table_a1">
        <tbody>
          ...
          <tr>
            <td>Guten Morgen</td>
            <td>
              Доброе утро. Эту фразу вы можете сказать, как правило, до полудня.
            </td>
          </tr>
          <tr>
            <td>Guten Tag</td>
            <td>
              Добрый день. Данная фраза употребляется после полудня до 6 часов
              вечера.
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              Как дела (у вас)? — не забывайте, что данный вопрос является
              формальным.
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td>Und Ihnen?</td>
            <td>
              А у вас? Все эти фразы очень формальны и используются в ситуациях
              делового общения.
            </td>
          </tr>
        </tbody>
      ...
      <h1 className="mt-5">
        {" "}
        При неформальной ситуации общения используйте аналоги приведенных фраз,
        а именно:
      </h1>
      <table className="table_a1">
        <tbody>
      ...
      <p>
        Вопросы с вопросительным словом. В немецком языке вопросительные слова
        начинаются с буквы W (wo, wer, was, wie). По этой причине их часто
        называют W-Fragen. В W-Fragen вопросительное слово всегда стоит на
        первом месте, а глагол на втором.
      </p>
      <table className="table_a1">
        {" "}
        <tbody>
          ...
          <tr>
            <td>Ich wohne in Bischkek</td>
            <td>Я живу в Бишкеке а ты?</td>
          </tr>
          <tr>
      ...
      <Player props={24} />
      <h3>
        b Hören Sie noch einmal und lesen Sie mit. Ergänzen Sie das Formular.
      </h3>
